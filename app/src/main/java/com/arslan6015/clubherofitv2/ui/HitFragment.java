...
public class HitFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_hit, container, false);
        HITbarChart = root.findViewById(R.id.HITbarChart);

        getEntries();

        barDataSet = new BarDataSet(barEntries, "Hp Data Set");
        barData = new BarData(barDataSet);
        HITbarChart.setData(barData);
